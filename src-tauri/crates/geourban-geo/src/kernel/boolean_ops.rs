...
pub(crate) fn rings_to_polygon(rings: &[Vec<Pt>]) -> Result<Geometry<'static>, geos::Error> {
...
pub(crate) fn polygon_to_rings<'a, G: Geom<'a>>(poly: &G) -> Result<Vec<Vec<Pt>>, geos::Error> {
...
pub(crate) fn split_into_polygon_geoms(
...
pub use crate::domains::reconciliation::manzanos::{compute_manzanos, ManzanoFragment};
pub use crate::domains::roads::network::{compute_road_network_net, RoadNetworkNet};
