...
import { IconRectDashed, IconLasso, IconAlertTriangle, IconAlertCircle } from '../icons';
...
export default function EditTab({ onDeleteSelected, onFindOverlaps, onFindGaps }: EditTabProps) {
